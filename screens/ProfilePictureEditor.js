...
const ProfilePictureEditor = ({navigation, route}) => {
    ...
    const ToolBar = () => {
        ...
        <View style={{borderTopColor: "#B7B7B7", borderTopWidth: 1, paddingVertical: 8}}>
            <View style={[styles.row, {alignItems: 'center', justifyContent:"space-evenly", marginHorizontal:'0.5%'}]}>
                ...
                <CircleButton onPress={toggleResetModalVisibility} iconName={"trash-bin"} activeStyle={{color:"#FF9C9C", borderColor:"#FF9C9C"}} />
    ...
    const renderItem = ({ item }) => {
        ...
        const borderColor = item.id === selectedId&&pencilActive ? "#60B1B6" : "#B9B9B9";
        const borderWidth = item.id === selectedId ? 1.5 : 1;

        return (
            <Item
                item={item}
                onPress={() => {if(pencilActive){ setSelectedId(item.id); setColor(item.colorCode)}}}
        ...
        <View style={[styles.mainContainer]}>
            ...
            <View style={styles.box2}>
                ...
                <View style={{alignSelf: 'center', width:'90%',}}>
                    ...
                    <View style={styles.thicknessContainer}>
                        <View>
                            <Text style={{color: '#60B1B6', marginTop: 8, fontSize: 16}}>{eraserActive ? "Eraser Thickness" : "Brush Thickness"}</Text>
                        </View>
                        <View style={{width: '80%'}}>
                            <Slider
            ...
            >
                <View style={styles.centeredView}>
                    ...
                    <View style={{width:"70%", marginVertical:"2.5%", marginBottom: '8%'}}>
                    <FullButton
