...
const ImageScreen = ({route, navigation}) => {
    ...
    const getAllComments = async () => {
        ...
        try{
            ...
            const commentsRef = doc(collection(db, "uniqueImageNames", imageId.substring(0, imageId.indexOf('.')), "comments"));
            const querySnapshot = await getDocs(comm);
            const tempData = [];
    ...
    const postComment = async(comment) => {
        ...
        const newCommentRef = doc(collection(db, "uniqueImageNames", imageId.substring(0, imageId.indexOf('.')), "comments"));

        // Add a new document in collection "cities"
        await setDoc(newCommentRef, {
            commentText: comment,
            commentAuthor: auth.currentUser.uid,
    ...
    const getCommentData = async () => {
        // Create a new document with an autogenerated id
        const newCommentsRef = collection(db, "uniqueImageNames", imageId.substring(0, imageId.indexOf('.')), "comments");
